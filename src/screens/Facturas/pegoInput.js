...
const NormalInputs = ({initialValuesPego,activeBalance,allBalance,activeProvider}) =>  {
      ...
      <Menu
        ...
        //   button={<Text onPress={this.showMenu}>Show menu</Text>}
          button = {
            ...
            value={initialValuesPego.Servicio}
            mode='outlined'
        ...
        >
          <MenuItem onPress={()=>{ dispatch(
            FacturasActions.setInintalValuesPego({...initialValuesPego,"Servicio":"EPSA EPS ENERTOLIMA 1240"}
            ))
          ,hideMenu()}} >EPSA EPS ENERTOLIMA 1240</MenuItem>
          <MenuDivider />
        </Menu>
            <TextInput style={defaultStyle.InputText1Style}
              label="Referencia de Pago"
              value={initialValuesPego.Referencia}
              mode='outlined'
              // keyboardType="text"
              onChangeText={text => dispatch(FacturasActions.setInintalValuesPego({...initialValuesPego,"Referencia":text}))}
              underlineColor='transparent'
              underlineColorAndroid={'rgba(0,0,0,0)'}
              text='white'
              direction='rtl'
            ...
            />
              ...
              <TextInput
              label="Valor"
              value={initialValuesPego.Valor}
              style={defaultStyle.InputText1Style}
              mode='outlined'
              // keyboardType="text"
              onChangeText={text =>  dispatch(FacturasActions.setInintalValuesPego({...initialValuesPego,"Valor":text}))}
              underlineColor='transparent'
              underlineColorAndroid={'rgba(0,0,0,0)'}
              text='white'
              direction='rtl'
            ...
            />
             ...
             <TextInput
              label="Celular"
              value={initialValuesPego.Celular}
              style={defaultStyle.InputText1Style}
              mode='outlined'
              // keyboardType="text"
              onChangeText={text =>  dispatch(FacturasActions.setInintalValuesPego({...initialValuesPego,"Celular":text}))}
              underlineColor='transparent'
              underlineColorAndroid={'rgba(0,0,0,0)'}
              text='white'
              direction='rtl'
            ...
            />
             ...
             <TextInput
              ...
              value={initialValuesPego.Correo}
              style={defaultStyle.InputText1Style}
              mode='outlined'
              // keyboardType="text"
              onChangeText={text =>  dispatch(FacturasActions.setInintalValuesPego({...initialValuesPego,"Correo":text}))}
              underlineColor='transparent'
              underlineColorAndroid={'rgba(0,0,0,0)'}
              text='white'
              direction='rtl'
           ...
           <View style={{justifyContent:'space-around',flexDirection:'row'}}>
              ...
              <Button disabled={initialValuesPego.Servicio!=='' && initialValuesPego.Referencia!==''&&
               initialValuesPego.Valor!=='' && initialValuesPego.Correo!=='' && initialValuesPego.Celular!==''
              ?false:true}
              onPress={() => refRBSheet.current.open()}
              style={initialValuesPego.Servicio !=='' && initialValuesPego.Referencia!=='' && initialValuesPego.Valor !=='' && 
              initialValuesPego.Celular && initialValuesPego.Correo!=='' ?defaultStyle.buttonactive:defaultStyle.btn}>
                 <Text  style={{color:'#ffff'}}>Pagar Factura</Text>
                 </Button>
            </View>
            <View>
            <RBSheet
            ...
            <Text >{initialValuesPego.Referencia}</Text>
            </View>
            </View>
            <View style={defaultStyle.container}>
            <View 
            ...
            <View style={defaultStyle.textTable1}>
            <Text >{initialValuesPego.Servicio}</Text>
            </View>
            </View>
            <View style={defaultStyle.container}>
            <View 
            ...
            <View style={defaultStyle.textTable1}>
            <Text >{`${initialValuesPego.Valor} COP`}</Text>
            </View>
            </View>
...
const mapStateToProps = ({balance,Facturas}) => ({
    ...
    initialValuesPego:Facturas.initialValuesPego,
