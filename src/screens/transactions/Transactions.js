            ...
            <View style={styles.Contentcontainer}>
                ...
                >
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        >
                            <Text
                                style={{ ...styles.headerText, marginRight: 100, marginLeft: 14 }}
                            >ID</Text>
                            <Text
                            ...
                            >Servicio</Text>
                            <Text
                                style={{ ...styles.headerText, marginRight: 30 }}
                            >Estado</Text>
                            <Text
                        ...
                        <ScrollView
                            ...
                            showsHorizontalScrollIndicator={false}
                        >
                            {packgesData.map((item, index) => {
                                return (
                                    <View>
                                        <TouchableOpacity
                                            key={index}
                                            style={styles.listHeaderStyle}
                                            onPress={() => setToggleModel(item.toggle)}
                                        >
                                            ...
                                            >{item.Valor}</Text>
                                            <Text
                                                style={{ ...styles.listText, marginRight: 40 }}
                                            >{item.Servicio}</Text>
                                            <Image style={{ ...styles.listText, marginRight: 60 }} source={item.Estado} />
                                            <Image style={{ ...styles.listText, marginRight: 60 }} source={item.Archivos} />
                                        </TouchableOpacity>
                                    </View>
                                )
                            })}
