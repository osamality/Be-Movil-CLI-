  ...
  return (
    <Form style={{marginTop:1}}>
            <TextInput style={defaultStyle.InputText1Style}
              ...
              value={initialValues.Celular}
              mode='outlined'
              keyboardType="numeric"
              onChangeText={text => dispatch(certificadosActions.setInitialValues({...initialValues,"Celular":text}))}
            ...
            />
              ...
              mode='outlined'
              keyboardType="numeric"
              onChangeText={text =>  dispatch(certificadosActions.setInitialValues({...initialValues,"Valor":text}))}
              underlineColor='transparent'
              underlineColorAndroid={'rgba(0,0,0,0)'}
              text='white'
              direction='rtl'
           ...
           <View style={{justifyContent:'space-around',flexDirection:'row'}}>
              ...
              <Button disabled={initialValues.Celular!=='' && initialValues.Valor!==''?false:true}
              onPress={() => refRBSheet.current.open()}
              style={initialValues.Celular !=='' && initialValues.Valor !=='' && activeProvider.name?defaultStyle.buttonactive:defaultStyle.btn}>
            ...
            <View style={defaultStyle.textTable1}>
            <Text >{initialValues.Celular}</Text>
            </View>
            </View>
            <View style={defaultStyle.container}>
            <View 
...
const mapStateToProps = ({balance,Internacional}) => ({
    activeBalance:balance.activeBalance,
    allBalance :balance.balance,
    activeProvider : Internacional.activeProvider,
    initialValues: Internacional.initialValues,
